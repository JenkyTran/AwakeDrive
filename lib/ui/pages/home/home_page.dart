            ...
            Scaffold(
              appBar: AppBar(
                actions: [
                  IconButton(
                    onPressed: () {
                      final mindLink = BlocProvider
                          .of<BluetoothDevicesConnectCubit>(context)
                          .devices
                          .firstWhere((e) => e.id == Constants.mindLinkMacAddress);
                      final mindLinkConnection = BlocProvider
                          .of<BluetoothDevicesConnectCubit>(context)
                          .classicConnections[Constants.mindLinkMacAddress];
